...
function[qrho]=GLOBE(qtimes)

if(nargin<1) qtimes=1;end;
...
LAM = 0.1386;       % half-life = 5s
% %LAM = 0.693;       % half-life = 1 s
% %LAM = 1.3863;       % half-life = 500ms
% LAM = 6.93;         % half-life = 100 ms
% %LAM = 69.315;      % half-life = 1 ms
% %LAM = 693.15;      % half-life = 1 ms
...
STRENGTH_VOLSEC = 0.04*qtimes; % CHANGE BACK
qrho=STRENGTH_VOLSEC;
