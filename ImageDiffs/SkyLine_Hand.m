...
for j=1:length(s)
    ...
    if(~isfile(fnew))
        ...
        if(opt==1)
            ...
            [bina,t]=binaryimageRGB(newim,newimall,t);
        else
            newim=im;
            [bina,t,skyl,dontcheck]=binaryimageBW(newim,t,dontcheck);
        end
...
function PlotIms(im,bina,skyl)
nosky=double(im).*bina;
...
function[bina,t,skyl,dontcheck]=binaryimageBW(im,t,dontcheck)
...
function[bina,t]=binaryimageRGB(newim,imrgb,t)
