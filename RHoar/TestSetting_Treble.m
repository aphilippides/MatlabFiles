% example run
% TestSetting_Treble('exceldata_15-jul-2009.txt',240,0,0.5,1500,0,0.5,240,0,0.5,240,24,50,250,120,0,0)

function[bs1,bs2,NumTrades] = TestSetting_Treble(fin,nSm,EndPt,RP, ...
    nSUD,EPUD,RPUD,nSUD2,EPUD2,RPUD2,TimeLim,p1p2Lim,Fib,RepTime, ...
    nSF,EPF,RPF)%,nST,TOv)
...
while 1
    s=input('resize window then press 0 to continue:  ');
    if(isequal(s,0)) break; end;
end
