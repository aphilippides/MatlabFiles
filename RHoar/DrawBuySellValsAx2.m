function DrawBuySellValsAx2(buysell,m1m2,p1p2,updown,ud2,s1s2,e1e2,d1d2, ...
...
if(~isempty(s1s2))
    ...
    if(~isempty(lastb))
        ...
        text(xpos2,0.675*aht+ycm,str,'Units','centimeter', ...
            'Color','b','FontSize',fs);
    end
    lastb=find(s1s2(:,2)==0,1,'last');
    if(~isempty(lastb))
        str=['LOW1: ' num2str(s1s2(lastb,3))];
        text(xpos2,0.6*aht+ycm,str,'Units','centimeter', ...
            'Color','r','FontSize',fs);
    end
end
if(~isempty(e1e2))
    ...
    if(~isempty(lastb))
        ...
        text(xpos2,0.475*aht+ycm,str,'Units','centimeter', ...
            'Color','b','FontSize',fs);
    end
    lastb=find(e1e2(:,2)==0,1,'last');
    if(~isempty(lastb))
        str=['DSEL: ' num2str(e1e2(lastb,3))];
        text(xpos2,0.4*aht+ycm,str,'Units','centimeter', ...
            'Color','r','FontSize',fs);
    end
end
if(~isempty(d1d2))
    ...
    if(~isempty(lastb))
        ...
        text(xpos2,0.275*aht+ycm,str,'Units','centimeter', ...
            'Color','b','FontSize',fs);
    end
    lastb=find(d1d2(:,2)==0,1,'last');
    if(~isempty(lastb))
        str=['TSEL: ' num2str(d1d2(lastb,3))];
        text(xpos2,0.2*aht+ycm,str,'Units','centimeter', ...
            'Color','r','FontSize',fs);
    end
end
if(~isempty(chanBS))
    ...
    if(~isempty(lastb))
        ...
        text(xpos2,0.075*aht+ycm,str,'Units','centimeter', ...
            'Color','b','FontSize',fs);
    end
    lastb=find(chanBS(:,2)==0,1,'last');
    if(~isempty(lastb))
        str=['CHSEL: ' num2str(chanBS(lastb,3))];
        text(xpos2,0*aht+ycm,str,'Units','centimeter', ...
            'Color','r','FontSize',fs);
    end
end
if(~isempty(retBS))
    ...
    if(~isempty(lastb))
        ...
        text(xpos2,0.875*aht+ycm,str,'Units','centimeter', ...
            'Color','b','FontSize',fs);
    end
    lastb=find(retBS(:,2)==0,1,'last');
    if(~isempty(lastb))
        str=['RSEL: ' num2str(retBS(lastb,3))];
        text(xpos2,0.8*aht+ycm,str,'Units','centimeter', ...
            'Color','r','FontSize',fs);
    end
end
if(tr==1) text(xpos2,0.95*aht+ycm,trs,'FontSize',14,'Color','b','Units','centimeter');
elseif(tr==0) text(xpos2,0.95*aht+ycm,trs,'FontSize',14,'Color','r','Units','centimeter');
end