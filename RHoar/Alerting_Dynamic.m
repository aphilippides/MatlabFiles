% function[bs1,bs2,NumTrades] = Alerting_Dynamic(fin,nSmooth,EndPt,RangeProp,nSmoothUD,EndPtUD,RepTime)
...
for i=1:N;
    ...
    hold off;
    drawnow;
    if(mod(i,1000)==0) save(fn,'l1','l2','l3','t','timez','buysell','updown','buy','sell'); end
    WriteExcelData(timez(i,(4:6)),l1(i),l2(i),l3(i),buy(i),sell(i),fout2);
    i
    td=GetSecs-ts;
    w=PauseLen-td;
...
figure(2)
is=1:length(l1);
plot(is,l1,'g',is,l2,'g',is,l3,'g','Linewidth',2)
hold on
