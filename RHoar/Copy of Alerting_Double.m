% function[bs1,bs2,NumTrades] = TestSetting_Double(fin,nSm,EndPt,RP,nSUD,EPUD,RPUD,nSUD2,EPUD2,RPUD2,RepTime)
...
%         if(length(MMin)) plot(MMinT,MMin,'bo'); end;
    ...
    if(i>(StartT+nS2UD2+2))
        ...
        if(LastUD2==1) text(xl+100,l3(i)+0.18,'UP2','FontSize',14,'Color','b');
        elseif(LastUD2==0) text(xl+100,l3(i)+0.18,'DOWN2','FontSize',14,'Color','r');
        end
    end
    axis([xl-1 i (l3(i)-0.25) (l3(i)+0.25)])
...
figure(2)
plot(1:length(l1),l1,'g',1:length(l2),l2,'g',1:length(l3),l3,'g','Linewidth',2)
hold on
plot(1:length(s3),s3,'m',1:length(s2),s2,'b',1:length(s1),s1,'r','Linewidth',2);
if(length(ma3)) plot(ma3,ma3_s,'r.'); end;
if(length(mi3)) plot(mi3,mi3_s,'b.'); end;
if(length(MMax)) plot(MMaxT,MMax,'ro'); end;
if(length(MMin)) plot(MMinT,MMin,'bo'); end;
...
plot(1:length(l1),l1,'g',1:length(l2),l2,'g',1:length(l3),l3,'g','Linewidth',2)
hold on
plot(1:length(s3),s3,'m',1:length(s2_2),s2_2,'b',1:length(s1_2),s1_2,'r','Linewidth',2);
% if(length(ma3)) plot(ma3,ma3_s,'r.'); end;
% if(length(mi3)) plot(mi3,mi3_s,'b.'); end;
% if(length(MMax)) plot(MMaxT,MMax,'ro'); end;
% if(length(MMin)) plot(MMinT,MMin,'bo'); end;
