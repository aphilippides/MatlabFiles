function diffusionT (Anzahl, Dauer, xMax, yMax,opt,plen)
...
for i = 1:Anzahl
    ...
    if(opt==0)
        Position(1, i) = randn(1)*2+xMax/2;
        Position(2, i) = randn(1)*2+yMax/2;
    elseif(opt==1)
        Position(1, i) = max(randn(1)*5,0);
        Position(2, i) = rand(1)*yMax;
    else
        Position(1, i) = max(randn(1)*5,0)+xMax/2;
        Position(2, i) = rand(1)*yMax;
    end
end;
