function[newos,newcs,os,cs,len,bads,unsure,ignore]=SmoothOsScanning(os,t,cs,len,fn,...
...
smc(:,1)=TimeSmooth(cs(:,1),t,sm_len)';
smc(:,2)=TimeSmooth(cs(:,2),t,sm_len)';
for i=1:10%maxl
    ...
    sc(:,1)=TimeSmooth(cc(goodis,1),t(goodis),sm_len)';
    sc(:,2)=TimeSmooth(cc(goodis,2),t(goodis),sm_len)';
