...
% function [med,iq_r] = circ_median(alpha,dim)
%
...
%
% Altered by AP to return NaN if alpha's empty and to compute iqr
% not yet computing iqr
...
for i=1:M(3-dim)
  ...
  m1 = sum(circ_dist2(beta,beta)>0,1);
  m2 = sum(circ_dist2(beta,beta)<0,1);
