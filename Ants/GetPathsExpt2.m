function[outf,rms]=GetPathsExpt2(f,fn,FRLEN,vObj)
...
outf=[f 'Path.mat'];
save(outf,'FrameNum','MeanCol','WhichB','FullFrame','bigsmall', ...
...
if(nargin<1) 
    rms=ShowBeePathExpt2(outf);
else
    rms=ShowBeePathExpt2(outf,1,2,FRLEN,vObj);
end
