...
save(AllN,'ang_e','Cents','len_e','bads','unsure','ignore','setvals','nx','-append')
...
% get the unsure frames
unsure=setdiff(unsure,bads);
unsureFrs=FrameNum(unsure);

save(AllN,'unsure','bads','unsureFrs','-append');
...
% get the new frames of the unsures
clear unsure bads
unsure=[];
...
save(AllN,'sOr','unsure','ignore','-append')
