...
function[ma_t,ma_s,mi_t,mi_s,ma,mi]=GetArcs(o,t,thresh_s,thresh_t,Plotting)

if(nargin<3) thresh_s=pi/72; end;
if(nargin<4) thresh_t=0.025; end;
if(nargin<5) Plotting=1; end;

a=AngleWithoutFlip(o);
