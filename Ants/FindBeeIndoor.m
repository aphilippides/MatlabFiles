% Function to find bees from the indoor video
% normally called from TrackBeeHand
% Can define a threshold instead of having it auto defined as here

function[Areas,Cents,Orients,Stripiness,EndPt,NumBees,bounds]=FindBeeIndoor(im,t)
