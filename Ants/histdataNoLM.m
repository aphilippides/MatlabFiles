% function[fos,frns,fns]=histdataNoLM(inout,dn)
%
...
% USAGE:
%
% to choose files and distances: >> histdataNoLM
% to choose files with 'out' in them and distances: >> histdataNoLM('out')
% to choose files and data less than 5 from the nest >> histdataNoLM([],5)

function[fos,frns,fns,PeakOs,TimeOfDay,Peak2Os]=histdata(inout,dn,plotting,an,ts,ndiv)
