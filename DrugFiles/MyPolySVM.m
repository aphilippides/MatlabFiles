...
for i=1:length(Gamma)
   ...
   %for j=1:length(Epsi)
      j
      [Rate(i,j),MisLabs,sc]=GetSVC(train',LabelsTrain,test',LabelsTest,Gamma(i),Degree(j),Epsi);
...
function[HRate,MLabs, scores]=GetSVC(Tr,LabTr,Te,LabTe,Gamma,Deg,Epsilon)

[AlphaY, SVs, Bias, Parameters, Ns]=PolySVC(Tr,LabTr, Deg);
