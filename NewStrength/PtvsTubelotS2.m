...
filename = ['StructuresdataS/SP1_sp_30burst_1.05d_'num2str(d) '.mat'];

eval(['load ' filename ]);
sphere_conc1 = sphere_conc;
...
filename = ['SP2'  num2str(NUM_SPKES) '_sp_' num2str(SPHE_OUT) 'burst_'num2str(BURST_LENGTH2) 'd_'num2str(d) '.mat']
