function GetDensityMaxAvgs(Dens,Sl,Vers,StoreAvgs,MStr)
...
for i=1:length(Vers)			% Get average data
   filename=[MStr 'TreeRho'x2str(Dens) '/TreeSst1V' int2str(Vers(i)) 'MaxGr300X100Z100Sq1Sp10Sl' num2str(Sl) '.dat'];
	M=load(filename);
...
if(StoreAvgs)
filename=[MStr 'TreeRho'x2str(Dens) '/TreeAvgsSst1MaxGr300X100Z100Sq1Sp10Sl' num2str(Sl) '.mat'];
