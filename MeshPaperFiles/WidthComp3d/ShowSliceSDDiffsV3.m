function ShowSliceSDDiffsV3(Timee,NumBins)
...
subplot('Position',[0.125 0.59 0.825 0.39])
...
subplot('Position',[0.125 0.09 0.825 0.39])
...
set(FigHdl,'Position',[X(1) X(2) 8.8 12]);
